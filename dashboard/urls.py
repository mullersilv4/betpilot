...
urlpatterns = [
    ...
    path('assinatura/checkout/<str:plan>/', views.subscription_checkout, name='subscription_checkout'),
    path('webhooks/mercado-pago/', views.mercado_pago_webhook, name='mercado_pago_webhook'),
